...
void GS_GL20SC_VERT_DRE_ROBUSTNESS_TC_004(void) {
	...
	glDrawRangeElements(GL_POINTS, 0, 0xFFFFFFFF, 1, GL_UNSIGNED_BYTE,
			    NULL);
	GLenum err = glGetError();
...
/* Initialization */
void GS_GL20SC_VERT_DRE_ROBUSTNESS_TP_001_init(void) {}

void GS_GL20SC_VERT_DRE_ROBUSTNESS_TP_001_draw(void) {
	GS_GL20SC_VERT_DRE_ROBUSTNESS_TC_001();
	GS_GL20SC_VERT_DRE_ROBUSTNESS_TC_002();
	GS_GL20SC_VERT_DRE_ROBUSTNESS_TC_003();
	GS_GL20SC_VERT_DRE_ROBUSTNESS_TC_004();
}

/* Cleanup */
void GS_GL20SC_VERT_DRE_ROBUSTNESS_TP_001_close(void) {
