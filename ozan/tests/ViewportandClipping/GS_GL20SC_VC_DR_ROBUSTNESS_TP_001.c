...
void GS_GL20SC_VC_DR_ROBUSTNESS_TC_003(void) {
	...
	for (i = 0; i < count; i++) {
		...
		TEST_LOG_INFO("near=%lf far=%lf -> 0x%X", tests[i][0],
			      tests[i][1], err);
...
/* Initialization */
void GS_GL20SC_VC_DR_ROBUSTNESS_TP_001_init(void) {

	CHECK_ERROR(test_procedure);
	GS_GL20SC_VC_DR_ROBUSTNESS_TC_001();
	CHECK_ERROR(test_procedure);
	GS_GL20SC_VC_DR_ROBUSTNESS_TC_002();
	CHECK_ERROR(test_procedure);
	GS_GL20SC_VC_DR_ROBUSTNESS_TC_003();
	CHECK_ERROR(test_procedure);
	GS_GL20SC_VC_DR_ROBUSTNESS_TC_004();
	CHECK_ERROR(test_procedure);
	GS_GL20SC_VC_DR_ROBUSTNESS_TC_005();
	CHECK_ERROR(test_procedure);
	GS_GL20SC_VC_DR_ROBUSTNESS_TC_006();
	CHECK_ERROR(test_procedure);

}

void GS_GL20SC_VC_DR_ROBUSTNESS_TP_001_draw(void) {
}
/* Cleanup */
void GS_GL20SC_VC_DR_ROBUSTNESS_TP_001_close(void) {
